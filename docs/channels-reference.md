...
```bash
rg -n "Matrix|Telegram|Discord|Slack|Mattermost|Signal|WhatsApp|Email|IRC|Lark|DingTalk|QQ|iMessage|BlueBubbles|Nostr|Webhook|Channel|ACP" /tmp/zeroclaw.log
```
