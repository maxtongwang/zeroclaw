...
Κάθε κανάλι (Telegram, Discord, BlueBubbles κ.λπ.) έχει τη δική του ενότητα στο αρχείο.
...
Παράδειγμα για **BlueBubbles (iMessage)**:
...
send_read_receipts = true   # αποστολή read receipt μετά από κάθε μήνυμα

# Προαιρετική αναφορά σε ομάδες — τα DM δεν επηρεάζονται
